...
import { analyzeDTCs, searchYouTubeVideos, validateVideoResources, analyzeDiagramImage, searchVehicleReferences, generateVehicleTechnicalData } from "@/lib/gemini";
